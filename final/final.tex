...
\begin{abstract}
    ...
    Code for the analysis can be found at this \href{https://github.com/ematth/CS-412-Proj/tree/main}{Github Repository}.
\end{abstract}
\pagebreak
...
Nevertheless, results concerning both cross-sectional and sequential data have shown great promise with respect to accuracy optimization.
